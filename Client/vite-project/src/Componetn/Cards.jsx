...
export const Cards = () => {
  ...
  return (
    ...
    <div className="w-full py-4 overflow-hidden bg-white">
      <div
        ref={scrollRef}
        className="flex space-x-4 sm:space-x-6 md:space-x-8 px-4 items-start overflow-x-hidden"
      >
        {dummyProducts.slice(0, 10).map((data) => (
          <div
            key={data._id}
            className="bg-red-50 flex-shrink-0 w-56 sm:w-64 md:w-72 lg:w-80 rounded-lg p-4 shadow-md hover:shadow-lg transition"
          >
